...
QT_MOC_LITERAL(4, 23, 6), // "weight"
QT_MOC_LITERAL(5, 30, 5) // "error"

    },
    "SocketThread\0data\0\0tag\0weight\0error"
};
...
void SocketThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->data((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (SocketThread::*)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketThread::data)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SocketThread::data(QString _t1, int _t2)
{
