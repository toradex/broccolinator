...
QT_MOC_LITERAL(5, 46, 16) // "downloadFinished"

    },
    "CameraThread\0frameReady\0\0QNetworkReply*\0"
    "reply\0downloadFinished"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameReady((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CameraThread::*)(QNetworkReply * );
...
// SIGNAL 0
void CameraThread::frameReady(QNetworkReply * _t1)
{
